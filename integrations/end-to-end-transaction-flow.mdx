...
description: "How to request a quote from Alyra API and execute the returned transaction"
---
...
| `originCurrency`      | string | ✅       | Token you are sending (symbol or address, depending on your integration).                            |
| `destinationCurrency` | string | ✅       | Token you want to receive (symbol or address, depending on your integration).                        |
