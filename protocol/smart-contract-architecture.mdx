...
Business logic lives inside Facet contracts, each responsible for interacting with a specific type of liquidity provider (e.g., bridges, DEXs, solvers).
...
4. Settlement completes on the destination chain exactly as specified in the packet, or reverts safely if constraints are violated.
   ...
   ![Contracts Pn](/images/contracts.png)
